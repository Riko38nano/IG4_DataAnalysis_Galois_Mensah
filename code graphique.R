...
donnees = read_excel("C:/Users/Nico/Desktop/IG4_S7/Projet_Data_Analyse/BDD brute Confinement.xlsx")
...
#Exemple
tableauRecapEffectifFrequence(data[,7])
...
#Exemple
grapheUnivar(donneesTravailleur$`Evolution budget agrégé`, "", "Evolution du budget")
...
#Exemple
par(mar = rep(2, 4))
graphe_mosaic(data$`Avez-vous découvert une activité en lien avec le 2-roues motorisé au cours du confinement ?`, `A 2-roues motorisé - Dans les mois qui vont suivre`, "","","")
